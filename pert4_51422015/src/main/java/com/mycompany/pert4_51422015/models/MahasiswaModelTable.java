 ...
 */
package com.mycompany.pert4_51422015.models;
 ...
 * @author DIO
 */
public class MahasiswaModelTable extends AbstractTableModel{
    private List<MahasiswaModel> mhsList;
    private String[] columnNames = {"ID", "NPM", "Nama", "Semester", "IPK"};
    
    public MahasiswaModelTable(List<MahasiswaModel> mhsList){
        this.mhsList = mhsList;
    }
    
    @Override
    public int getRowCount() {
        return mhsList.size(); // Jumlah baris sesuai dengan jumlah data mahasiswa
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        MahasiswaModel mahasiswa = mhsList.get(rowIndex);
        switch (columnIndex) {
            case 0:
